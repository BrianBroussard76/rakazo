...
Permission records include the recipient, Space, disclosure version, and time. Choose Not now to decline, or withdraw permission in Account → AI data sharing to stop future requests. Withdrawal cannot recall data already sent or undo processing in progress. Changed recipients, models, endpoints, or disclosures require new permission.
